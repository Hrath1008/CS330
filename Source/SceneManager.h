...
// SceneManager.h
//
// Defines the SceneManager class, which is responsible for preparing and
// rendering the 3D scene. The class manages textures, materials, lighting,
// object transformations, and rendering operations.
//
