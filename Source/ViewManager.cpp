...
// ViewManager.cpp
//
// Implements the ViewManager class. This file manages GLFW window creation,
// camera input, view selection, and the view/projection shader uniforms used
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	float xOffset = (xMousePos - gLastX) * mouseSensitivity;
 ...
 ***********************************************************/
void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double x, double yOffset)
{
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS)
	{
		...
		g_pCamera->Position = glm::vec3(0.0f, 5.5f, 13.75f);
		g_pCamera->Front = glm::vec3(0.0f, -0.5f, -2.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
		//g_pCamera->Zoom = 80;
	}
